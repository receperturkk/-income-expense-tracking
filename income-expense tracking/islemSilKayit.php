...
if (silMuhasebeKayit($ID)) {
    ...
    <div>
      <span class="font-medium">BAŞARILI</span> Kayıt başarılı bir şekilde silindi.
    </div>
  </div>';
}
...
<span class="sr-only">Info</span>
<div>
  <span class="font-medium">HATA!</span> Kayıt silinemedi. Lütfen tekrar deneyiniz.
</div>
</div>';
echo ' <div class="flex items-center justify-center w-full">
<a href="index.php">
<button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ana Sayfa</button></a></div>'
?>
